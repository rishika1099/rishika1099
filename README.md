...
<h1 align="center">Hi, I'm Rishika! <img src="./images/waving-cat.gif" width="40"></h1>

<h3 align="center">
  <img src="https://readme-typing-svg.herokuapp.com?font=Montserrat&weight=500&size=24&duration=3000&pause=800&color=D9BED1&center=true&vCenter=true&width=600&lines=Data+Scientist;Machine+Learning+Engineer;AI+Engineer;Deep+Learning+Engineer;NLP+Researcher" alt="Typing SVG" />
</h3>
...
const rishika = {
  ...
  education: [
    "Columbia University 🎓 | MS Data Science (Expected Dec 2026)",
...
achievements = {
    ...
    "NLP_Clinical_Trials": {
        ...
        "tools": ["Python", "NLP"],
        "result": "Reduced manual review time for document analysis 📊"
    }
}
```
...
achievements = {
    "Campaign_Data_Analysis": {
        ...
        "result": "Improved campaign analysis and resource allocation 📈"
    }
}
```
...
![Education](https://img.shields.io/badge/Education-1E88E5?style=flat-square)
![Public Sector](https://img.shields.io/badge/Public_Sector-6D4C41?style=flat-square)
![Legal](https://img.shields.io/badge/Legal-3949AB?style=flat-square)
![Human Rights](https://img.shields.io/badge/Human_Rights-8E24AA?style=flat-square)
![Finance](https://img.shields.io/badge/Finance-43A047?style=flat-square)
![Cybersecurity](https://img.shields.io/badge/Cybersecurity-424242?style=flat-square)
![Agriculture](https://img.shields.io/badge/Agriculture-7CB342?style=flat-square)
![Food & Nutrition](https://img.shields.io/badge/Food_%26_Nutrition-FF7043?style=flat-square)
![Creative AI](https://img.shields.io/badge/Creative_AI-AB47BC?style=flat-square)

**Technical Areas**

![Machine Learning](https://img.shields.io/badge/Machine_Learning-F57C00?style=flat-square)
![Deep Learning](https://img.shields.io/badge/Deep_Learning-D84315?style=flat-square)
![Computer Vision](https://img.shields.io/badge/Computer_Vision-1E88E5?style=flat-square)
![Generative AI](https://img.shields.io/badge/Generative_AI-8E24AA?style=flat-square)
![Agentic AI](https://img.shields.io/badge/Agentic_AI-5E35B1?style=flat-square)
![NLP](https://img.shields.io/badge/NLP-039BE5?style=flat-square)
![RAG](https://img.shields.io/badge/RAG-00ACC1?style=flat-square)
![Causal Inference](https://img.shields.io/badge/Causal_Inference-43A047?style=flat-square)
![Statistical Modeling](https://img.shields.io/badge/Statistical_Modeling-00897B?style=flat-square)
![Explainable AI](https://img.shields.io/badge/Explainable_AI-FB8C00?style=flat-square)
![Multimodal AI](https://img.shields.io/badge/Multimodal_AI-3949AB?style=flat-square)
![High Performance ML](https://img.shields.io/badge/High_Performance_ML-5E35B1?style=flat-square)
![LLM Systems](https://img.shields.io/badge/LLM_Systems-283593?style=flat-square)
...
| [Agent-Behavior-Replay-Diff](https://github.com/rishika1099/Agent-Behavior-Replay-Diff) | Record-and-replay behavioural diffs for agent changes: path divergence vs outcome equivalence | Python | ![Agentic AI](https://img.shields.io/badge/Agentic_AI-5E35B1?style=flat-square) |
| [Prompt-Injection-Defense-Benchmark](https://github.com/rishika1099/Prompt-Injection-Defense-Benchmark) | Defensive benchmark: do agent architectures reduce prompt-injection susceptibility? Inert canary tokens only | JavaScript | ![Agentic AI](https://img.shields.io/badge/Agentic_AI-5E35B1?style=flat-square) |
| [Agent-Cost-Vs-Accuracy-Frontier](https://github.com/rishika1099/Agent-Cost-Vs-Accuracy-Frontier) | Compare agent architectures at matched cost, not matched accuracy: the cost/accuracy frontier | JavaScript | ![Agentic AI](https://img.shields.io/badge/Agentic_AI-5E35B1?style=flat-square) |
| [Source-Attributed-Summarizer](https://github.com/rishika1099/Source-Attributed-Summarizer) | A summariser where every sentence carries its source span and unsupported ones are flagged, with a validated NLI verifier | Python | ![NLP](https://img.shields.io/badge/NLP-039BE5?style=flat-square) |
...
| [LLM-Model-Router-Benchmark](https://github.com/rishika1099/LLM-Model-Router-Benchmark) | Cost-, latency-, and quality-aware model router benchmarked against always-large and always-small baselines over a 4k-request workload | Python | ![LLM Systems](https://img.shields.io/badge/LLM_Systems-283593?style=flat-square) ![High Performance ML](https://img.shields.io/badge/High_Performance_ML-5E35B1?style=flat-square) |
...
| [Chain-Of-Thought-Early-Exit](https://github.com/rishika1099/Chain-Of-Thought-Early-Exit) | Adaptive reasoning-depth controller that exits chain-of-thought early once the answer stabilizes, compared against fixed budgets and self-consistency | Python | ![LLM Systems](https://img.shields.io/badge/LLM_Systems-283593?style=flat-square) ![High Performance ML](https://img.shields.io/badge/High_Performance_ML-5E35B1?style=flat-square) |
| [LLM-Long-Context-Stress-Tests](https://github.com/rishika1099/LLM-Long-Context-Stress-Tests) | Long-context stress tests: lost-in-the-middle heatmaps, multi-hop joins, instruction retention, distractor robustness, and the latency and KV-memory bill | Python | ![LLM Systems](https://img.shields.io/badge/LLM_Systems-283593?style=flat-square) ![High Performance ML](https://img.shields.io/badge/High_Performance_ML-5E35B1?style=flat-square) |
...
| [LLM-Self-Consistency-Calibration](https://github.com/rishika1099/LLM-Self-Consistency-Calibration) | Does agreement across reasoning chains predict correctness? Calibration curves, ECE, and five selection strategies evaluated against chain count | Python, calibration metrics | ![LLM Systems](https://img.shields.io/badge/LLM_Systems-283593?style=flat-square) ![Explainable AI](https://img.shields.io/badge/Explainable_AI-FB8C00?style=flat-square) |
| [Structured-LLM-Output-Reliability](https://github.com/rishika1099/Structured-LLM-Output-Reliability) | Fault-injection harness for structured outputs, comparing JSON mode, function calling, grammar constraints, and a staged repair pipeline | Python | ![LLM Systems](https://img.shields.io/badge/LLM_Systems-283593?style=flat-square) ![Generative AI](https://img.shields.io/badge/Generative_AI-8E24AA?style=flat-square) |
| [LLM-Reasoning-Regression-Tests](https://github.com/rishika1099/LLM-Reasoning-Regression-Tests) | Regression testing for LLM reasoning: declarative test specs, consistency checks, and a CI gate that fails deploys on category regressions | Python, CI | ![LLM Systems](https://img.shields.io/badge/LLM_Systems-283593?style=flat-square) |
...
| [Local-LLM-Energy-Cost-Frontier](https://github.com/rishika1099/Local-LLM-Energy-Cost-Frontier) | The accuracy-vs-cost Pareto frontier for local LLM inference on Apple silicon, energy included | Python | ![LLM Systems](https://img.shields.io/badge/LLM_Systems-283593?style=flat-square) |
| [LLM-Over-Refusal-Rate](https://github.com/rishika1099/LLM-Over-Refusal-Rate) | A false-positive rate for LLM safety behaviour: does the model refuse legitimate, sensitive-adjacent requests? | Python | ![LLM Systems](https://img.shields.io/badge/LLM_Systems-283593?style=flat-square) |
...
| Project | Description | Tech Stack | Tags |
|---------|-------------|------------|------|
| [Colon-Cancer-Trial-Causal-Analysis](https://github.com/rishika1099/Colon-Cancer-Trial-Causal-Analysis) | Causal-inference re-analysis of the Moertel 1990 adjuvant colon cancer trial with five nested estimands: ATE estimation, backdoor adjustment, bad-control demonstration, CATE, mediation analysis, and transportability | Python, lifelines, statsmodels, EconML | ![Healthcare](https://img.shields.io/badge/Healthcare-E91E63?style=flat-square) ![Causal Inference](https://img.shields.io/badge/Causal_Inference-43A047?style=flat-square) ![Statistical Modeling](https://img.shields.io/badge/Statistical_Modeling-00897B?style=flat-square) |
| [Colorectal-Cancer-Risk-Analysis](https://github.com/rishika1099/Colorectal-Cancer-Risk-Analysis) | Visual and statistical analysis of diet and lifestyle factors associated with colorectal cancer risk | R, ggplot2 | ![Healthcare](https://img.shields.io/badge/Healthcare-E91E63?style=flat-square) ![Statistical Modeling](https://img.shields.io/badge/Statistical_Modeling-00897B?style=flat-square) |
| [Mediation-Analysis-Sensitivity-Dial](https://github.com/rishika1099/Mediation-Analysis-Sensitivity-Dial) | A mediation analysis where the reader turns the untestable assumptions: DML effects with an interactive sensitivity dial | Python | ![Causal Inference](https://img.shields.io/badge/Causal_Inference-43A047?style=flat-square) |
| [Shape-Bucketing-For-Recompilation](https://github.com/rishika1099/Shape-Bucketing-For-Recompilation) | Shape bucketing as an optimisation over a real request-length distribution: DP-optimal buckets vs the recompilation storm | JavaScript | ![Statistical Modeling](https://img.shields.io/badge/Statistical_Modeling-00897B?style=flat-square) |
| [Causal-Discovery-Under-Measurement-Error](https://github.com/rishika1099/Causal-Discovery-Under-Measurement-Error) | Benchmarking causal discovery under realistic measurement error, with a reliability-correction fix | Python | ![Causal Inference](https://img.shields.io/badge/Causal_Inference-43A047?style=flat-square) |
| [Camera-Trap-Detector-Failure-Generation](https://github.com/rishika1099/Camera-Trap-Detector-Failure-Generation) | Generate the conditions that break your detector, measure the per-edit taxonomy, then train on the failures | Python | ![Causal Inference](https://img.shields.io/badge/Causal_Inference-43A047?style=flat-square) |
...
| Project | Description | Tech Stack | Tags |
|---------|-------------|------------|------|
| [Safe-Start-NCANDS-Child-Welfare-Prediction](https://github.com/rishika1099/Safe-Start-NCANDS-Child-Welfare-Prediction) | ML and predictive analytics framework for identifying high-risk child welfare cases using NCANDS administrative data, explainable models, and fairness auditing | Python, scikit-learn, SHAP, Jupyter | ![Public Sector](https://img.shields.io/badge/Public_Sector-6D4C41?style=flat-square) ![Machine Learning](https://img.shields.io/badge/Machine_Learning-F57C00?style=flat-square) ![Explainable AI](https://img.shields.io/badge/Explainable_AI-FB8C00?style=flat-square) |
| [Diabetes-Risk-Prediction](https://github.com/rishika1099/Diabetes-Risk-Prediction) | Gradient boosting pipeline with SHAP explainability for diabetes risk prediction | XGBoost, SHAP | ![Healthcare](https://img.shields.io/badge/Healthcare-E91E63?style=flat-square) ![Machine Learning](https://img.shields.io/badge/Machine_Learning-F57C00?style=flat-square) ![Explainable AI](https://img.shields.io/badge/Explainable_AI-FB8C00?style=flat-square) |
| [Heart-Disease-Prediction](https://github.com/rishika1099/Heart-Disease-Prediction) | Machine learning pipeline with EDA, SMOTE, and hyperparameter tuning for heart disease prediction | scikit-learn, SMOTE | ![Healthcare](https://img.shields.io/badge/Healthcare-E91E63?style=flat-square) ![Machine Learning](https://img.shields.io/badge/Machine_Learning-F57C00?style=flat-square) |
| [Car-Price-Prediction](https://github.com/rishika1099/Car-Price-Prediction) | Ensemble-based car price prediction with SHAP feature explanations | XGBoost, SHAP | ![Machine Learning](https://img.shields.io/badge/Machine_Learning-F57C00?style=flat-square) ![Explainable AI](https://img.shields.io/badge/Explainable_AI-FB8C00?style=flat-square) |
| [House-Price-Prediction](https://github.com/rishika1099/House-Price-Prediction) | XGBoost regression model on California housing data with app deployment | XGBoost, Streamlit | ![Machine Learning](https://img.shields.io/badge/Machine_Learning-F57C00?style=flat-square) |
| [Loan-Status-Prediction](https://github.com/rishika1099/Loan-Status-Prediction) | Gradient boosting classifier for loan status prediction with SHAP explanations | XGBoost, SHAP | ![Finance](https://img.shields.io/badge/Finance-43A047?style=flat-square) ![Machine Learning](https://img.shields.io/badge/Machine_Learning-F57C00?style=flat-square) ![Explainable AI](https://img.shields.io/badge/Explainable_AI-FB8C00?style=flat-square) |
| [Red-Wine-Quality-Prediction](https://github.com/rishika1099/Red-Wine-Quality-Prediction) | Gradient boosting regression with feature importance analysis for wine quality prediction | XGBoost, SHAP | ![Food & Nutrition](https://img.shields.io/badge/Food_%26_Nutrition-FF7043?style=flat-square) ![Machine Learning](https://img.shields.io/badge/Machine_Learning-F57C00?style=flat-square) |
| [Customer-Churn-Prediction](https://github.com/rishika1099/Customer-Churn-Prediction) | Predictive model for repeat purchase and churn behavior in food delivery | scikit-learn | ![Machine Learning](https://img.shields.io/badge/Machine_Learning-F57C00?style=flat-square) |
| [Rock-Mine-Prediction](https://github.com/rishika1099/Rock-Mine-Prediction) | Sonar signal classification comparing multiple ML models | scikit-learn | ![Machine Learning](https://img.shields.io/badge/Machine_Learning-F57C00?style=flat-square) |
| [Classifier-Failure-Mode-Clustering](https://github.com/rishika1099/Classifier-Failure-Mode-Clustering) | Cluster, name, and validate a classifier's failure modes, then prove the names identify held-out errors | Python | ![Machine Learning](https://img.shields.io/badge/Machine_Learning-F57C00?style=flat-square) |
| [Exercise-Form-Feedback](https://github.com/rishika1099/Exercise-Form-Feedback) | Dataset-free per-rep form feedback from your own best reps, validated on exactly-known degradations | Python | ![Machine Learning](https://img.shields.io/badge/Machine_Learning-F57C00?style=flat-square) |
| [ArXiv-Term-Meaning-Drift](https://github.com/rishika1099/ArXiv-Term-Meaning-Drift) | Diachronic term drift on arXiv with a seed-noise null and a held-out predictive test | Python | ![Machine Learning](https://img.shields.io/badge/Machine_Learning-F57C00?style=flat-square) |
| [Boosting-Vs-Deep-Learning-Crossover](https://github.com/rishika1099/Boosting-Vs-Deep-Learning-Crossover) | When does gradient boosting stop being the right model? Learning-curve crossovers across 20 tabular datasets, with a meta-feature recommender | JavaScript | ![Machine Learning](https://img.shields.io/badge/Machine_Learning-F57C00?style=flat-square) |
| [Reward-Hacking-Environments](https://github.com/rishika1099/Reward-Hacking-Environments) | A gallery of small environments where a plausible reward produces a degenerate policy, plus an honest look at detection | Python | ![Public Sector](https://img.shields.io/badge/Public_Sector-6D4C41?style=flat-square) ![Machine Learning](https://img.shields.io/badge/Machine_Learning-F57C00?style=flat-square) |
| [Hand-Eye-Calibration-Active-Learning](https://github.com/rishika1099/Hand-Eye-Calibration-Active-Learning) | Active learning for hand-eye calibration: D-optimal pose selection reaches target accuracy in far fewer poses | Python | ![Machine Learning](https://img.shields.io/badge/Machine_Learning-F57C00?style=flat-square) |
| [Model-Decay-Forecast](https://github.com/rishika1099/Model-Decay-Forecast) | Forecast when a tabular model will decay from early drift dynamics, with calibrated conformal intervals | Python | ![Machine Learning](https://img.shields.io/badge/Machine_Learning-F57C00?style=flat-square) |
| [Grokking-Onset-Prediction](https://github.com/rishika1099/Grokking-Onset-Prediction) | Predict the grokking (delayed-generalisation) jump from the first 10% of training, via gradient-noise dynamics | Python | ![Machine Learning](https://img.shields.io/badge/Machine_Learning-F57C00?style=flat-square) |
| [Underspecified-Question-Detector](https://github.com/rishika1099/Underspecified-Question-Detector) | A model that knows when a question is underspecified: answer-entropy ambiguity detection with clarifying questions | JavaScript | ![Machine Learning](https://img.shields.io/badge/Machine_Learning-F57C00?style=flat-square) |
| [Noisy-Label-Recovery](https://github.com/rishika1099/Noisy-Label-Recovery) | Recover true labels and annotator reliabilities from noisy votes with Dawid-Skene, and verify only the suspicious labels | Python | ![Machine Learning](https://img.shields.io/badge/Machine_Learning-F57C00?style=flat-square) |
| [Off-Policy-Evaluation-Failure-Map](https://github.com/rishika1099/Off-Policy-Evaluation-Failure-Map) | A logging simulator with known ground truth that maps where off-policy evaluation estimators lie | Python | ![Public Sector](https://img.shields.io/badge/Public_Sector-6D4C41?style=flat-square) ![Machine Learning](https://img.shields.io/badge/Machine_Learning-F57C00?style=flat-square) |
| [Negative-Control-Falsification-Tests](https://github.com/rishika1099/Negative-Control-Falsification-Tests) | Auto-propose and run the negative-control falsification tests an observational analysis should have failed | Python | ![Machine Learning](https://img.shields.io/badge/Machine_Learning-F57C00?style=flat-square) |
| [Synthetic-Control-Small-Donor-Pools](https://github.com/rishika1099/Synthetic-Control-Small-Donor-Pools) | Synthetic control on a tiny donor pool with honest placebo-permutation inference for small places | JavaScript | ![Machine Learning](https://img.shields.io/badge/Machine_Learning-F57C00?style=flat-square) |
| [Cost-Aware-Feature-Selection](https://github.com/rishika1099/Cost-Aware-Feature-Selection) | AutoML that refuses features on cost grounds, not just accuracy: joint accuracy-cost Pareto selection with a per-feature argument | JavaScript | ![Machine Learning](https://img.shields.io/badge/Machine_Learning-F57C00?style=flat-square) |
| [Preference-Based-Control](https://github.com/rishika1099/Preference-Based-Control) | Learn control from pairwise trajectory preferences with a direct objective, no reward model | Python | ![Machine Learning](https://img.shields.io/badge/Machine_Learning-F57C00?style=flat-square) |
| [Robot-Grasp-Ranking-With-Abstention](https://github.com/rishika1099/Robot-Grasp-Ranking-With-Abstention) | Ranked grasp hypotheses with stated reasons and an abstention option, plus the success-vs-coverage curve | Python | ![Machine Learning](https://img.shields.io/badge/Machine_Learning-F57C00?style=flat-square) |
| [Data-Ordering-Vs-Shuffling-Test](https://github.com/rishika1099/Data-Ordering-Vs-Shuffling-Test) | Does any data ordering beat shuffling at fixed compute, once scoring cost is counted? An honest negative | Python | ![Machine Learning](https://img.shields.io/badge/Machine_Learning-F57C00?style=flat-square) |
| [Offline-RL-Confidence-Intervals](https://github.com/rishika1099/Offline-RL-Confidence-Intervals) | Offline RL where the headline is the confidence interval's width and the power analysis, not a fragile point estimate | Python | ![Machine Learning](https://img.shields.io/badge/Machine_Learning-F57C00?style=flat-square) |
| [Authorship-Anonymizing-Rewriter](https://github.com/rishika1099/Authorship-Anonymizing-Rewriter) | Rewrite text so it means the same but no longer sounds like you: the anonymity-meaning frontier | Python | ![Machine Learning](https://img.shields.io/badge/Machine_Learning-F57C00?style=flat-square) |
| [Annotator-Disagreement-Preference-Map](https://github.com/rishika1099/Annotator-Disagreement-Preference-Map) | Map where annotators disagree over preference space, and how that reshapes reward models | Python | ![Machine Learning](https://img.shields.io/badge/Machine_Learning-F57C00?style=flat-square) |
| [Catastrophic-Forgetting-Dose-Response](https://github.com/rishika1099/Catastrophic-Forgetting-Dose-Response) | Catastrophic forgetting as a dose-response law, inverted into a calculator for the largest safe fine-tune | Python | ![Legal](https://img.shields.io/badge/Legal-3949AB?style=flat-square) ![Machine Learning](https://img.shields.io/badge/Machine_Learning-F57C00?style=flat-square) |
| [GPU-Memory-Fragmentation-Diagnosis](https://github.com/rishika1099/GPU-Memory-Fragmentation-Diagnosis) | Diagnose out-of-memory errors that are fragmentation, not capacity: a caching-allocator replay, a fragmentation-aware OOM detector, and a size-class fix that removes the OOM without adding memory | HTML | ![Machine Learning](https://img.shields.io/badge/Machine_Learning-F57C00?style=flat-square) |
| [Controller-Disturbance-Recovery-Benchmark](https://github.com/rishika1099/Controller-Disturbance-Recovery-Benchmark) | A little experiment on GitHub | JavaScript | ![Machine Learning](https://img.shields.io/badge/Machine_Learning-F57C00?style=flat-square) |
| [Failed-Training-Run-Diagnosis](https://github.com/rishika1099/Failed-Training-Run-Diagnosis) | A little experiment on GitHub | JavaScript | ![Machine Learning](https://img.shields.io/badge/Machine_Learning-F57C00?style=flat-square) |
...
| [RL-Curriculum-Out-Of-Range-Transfer](https://github.com/rishika1099/RL-Curriculum-Out-Of-Range-Transfer) | A little experiment on GitHub | HTML | ![Machine Learning](https://img.shields.io/badge/Machine_Learning-F57C00?style=flat-square) |
| [Attention-Kernel-Roofline-Benchmark](https://github.com/rishika1099/Attention-Kernel-Roofline-Benchmark) | A little experiment on GitHub | HTML | ![Machine Learning](https://img.shields.io/badge/Machine_Learning-F57C00?style=flat-square) |
| [Training-Parallelism-Config-Predictor](https://github.com/rishika1099/Training-Parallelism-Config-Predictor) | A little experiment on GitHub | JavaScript | ![Machine Learning](https://img.shields.io/badge/Machine_Learning-F57C00?style=flat-square) |
| [Sim-To-Real-Gap-Decomposition](https://github.com/rishika1099/Sim-To-Real-Gap-Decomposition) | A little experiment on GitHub | HTML | ![Machine Learning](https://img.shields.io/badge/Machine_Learning-F57C00?style=flat-square) |
| [Real-Latency-Robot-Control-Loop](https://github.com/rishika1099/Real-Latency-Robot-Control-Loop) | A little experiment on GitHub | JavaScript | ![Machine Learning](https://img.shields.io/badge/Machine_Learning-F57C00?style=flat-square) |
| [Physics-Plausibility-Trajectory-Scoring](https://github.com/rishika1099/Physics-Plausibility-Trajectory-Scoring) | A little experiment on GitHub | Python | ![Machine Learning](https://img.shields.io/badge/Machine_Learning-F57C00?style=flat-square) |
| [Keyword-Rules-Vs-Labeled-Data](https://github.com/rishika1099/Keyword-Rules-Vs-Labeled-Data) | A little experiment on GitHub | Python | ![Machine Learning](https://img.shields.io/badge/Machine_Learning-F57C00?style=flat-square) |
...
| [Plant-Disease-Detection](https://github.com/rishika1099/Plant-Disease-Detection) | ResNet50 transfer learning model for 38 plant disease classes | TensorFlow, ResNet50 | ![Agriculture](https://img.shields.io/badge/Agriculture-7CB342?style=flat-square) ![Deep Learning](https://img.shields.io/badge/Deep_Learning-D84315?style=flat-square) ![Computer Vision](https://img.shields.io/badge/Computer_Vision-1E88E5?style=flat-square) |
| [Image-Watermark-Survivability](https://github.com/rishika1099/Image-Watermark-Survivability) | What ordinary handling does to an image watermark: survivability cards for a block-DCT scheme (defensive) | Python | ![Computer Vision](https://img.shields.io/badge/Computer_Vision-1E88E5?style=flat-square) |
| [Image-Dataset-Shortcut-Audit](https://github.com/rishika1099/Image-Dataset-Shortcut-Audit) | A leakage audit for image datasets: masked-variant ablations that fingerprint what the dataset really teaches | Python | ![Computer Vision](https://img.shields.io/badge/Computer_Vision-1E88E5?style=flat-square) |
| [JPEG-Bitrate-Policy-For-Detectors](https://github.com/rishika1099/JPEG-Bitrate-Policy-For-Detectors) | The smallest file that keeps the detector right: per-image JPEG bitrate policy vs a global quality | Python | ![Public Sector](https://img.shields.io/badge/Public_Sector-6D4C41?style=flat-square) ![Computer Vision](https://img.shields.io/badge/Computer_Vision-1E88E5?style=flat-square) |
| [Audio-Labeled-Touch-Sensing](https://github.com/rishika1099/Audio-Labeled-Touch-Sensing) | A free touch sensor: audio auto-labels contact, a vision model learns it, then the microphone is thrown away | JavaScript | ![Internet of Things](https://img.shields.io/badge/Internet_of_Things-00838F?style=flat-square) ![Computer Vision](https://img.shields.io/badge/Computer_Vision-1E88E5?style=flat-square) |
...
| [Mixed-Precision-Layer-Search](https://github.com/rishika1099/Mixed-Precision-Layer-Search) | Search which layers actually need their bits: evolutionary per-layer mixed-precision quantization vs uniform | Python | ![High Performance ML](https://img.shields.io/badge/High_Performance_ML-5E35B1?style=flat-square) |
...
> **[View My Resume](./Rishika_Resume.pdf)** 📥
