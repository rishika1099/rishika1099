...
| [Agent-Replay](https://github.com/rishika1099/Agent-Replay) | Record-and-replay behavioural diffs for agent changes: path divergence vs outcome equivalence | Python | ![Agentic AI](https://img.shields.io/badge/Agentic_AI-5E35B1?style=flat-square) |
| [Injection-Sandbox](https://github.com/rishika1099/Injection-Sandbox) | Defensive benchmark: do agent architectures reduce prompt-injection susceptibility? Inert canary tokens only | JavaScript | ![Agentic AI](https://img.shields.io/badge/Agentic_AI-5E35B1?style=flat-square) |
| [Budget-Aware-Planning](https://github.com/rishika1099/Budget-Aware-Planning) | Compare agent architectures at matched cost, not matched accuracy: the cost/accuracy frontier | JavaScript | ![Agentic AI](https://img.shields.io/badge/Agentic_AI-5E35B1?style=flat-square) |
...
| [Joules-Per-Token](https://github.com/rishika1099/Joules-Per-Token) | The accuracy-vs-cost Pareto frontier for local LLM inference on Apple silicon, energy included | Python | ![LLM Systems](https://img.shields.io/badge/LLM_Systems-283593?style=flat-square) |
| [Over-Refusal-Ledger](https://github.com/rishika1099/Over-Refusal-Ledger) | A false-positive rate for LLM safety behaviour: does the model refuse legitimate, sensitive-adjacent requests? | Python | ![LLM Systems](https://img.shields.io/badge/LLM_Systems-283593?style=flat-square) |
...
| [Assumption-Dial](https://github.com/rishika1099/Assumption-Dial) | A mediation analysis where the reader turns the untestable assumptions: DML effects with an interactive sensitivity dial | Python | ![Causal Inference](https://img.shields.io/badge/Causal_Inference-43A047?style=flat-square) |
| [Recompilation-Storms](https://github.com/rishika1099/Recompilation-Storms) | Shape bucketing as an optimisation over a real request-length distribution: DP-optimal buckets vs the recompilation storm | JavaScript | ![Statistical Modeling](https://img.shields.io/badge/Statistical_Modeling-00897B?style=flat-square) |
| [Discovery-Measurement-Error](https://github.com/rishika1099/Discovery-Measurement-Error) | Benchmarking causal discovery under realistic measurement error, with a reliability-correction fix | Python | ![Causal Inference](https://img.shields.io/badge/Causal_Inference-43A047?style=flat-square) |
| [Counterfactual-Camera-Traps](https://github.com/rishika1099/Counterfactual-Camera-Traps) | Generate the conditions that break your detector, measure the per-edit taxonomy, then train on the failures | Python | ![Causal Inference](https://img.shields.io/badge/Causal_Inference-43A047?style=flat-square) |
...
| [Failure-Cartography](https://github.com/rishika1099/Failure-Cartography) | Cluster, name, and validate a classifier's failure modes, then prove the names identify held-out errors | Python | ![Machine Learning](https://img.shields.io/badge/Machine_Learning-F57C00?style=flat-square) |
| [Skill-Coach](https://github.com/rishika1099/Skill-Coach) | Dataset-free per-rep form feedback from your own best reps, validated on exactly-known degradations | Python | ![Machine Learning](https://img.shields.io/badge/Machine_Learning-F57C00?style=flat-square) |
| [Term-Drift](https://github.com/rishika1099/Term-Drift) | Diachronic term drift on arXiv with a seed-noise null and a held-out predictive test | Python | ![Machine Learning](https://img.shields.io/badge/Machine_Learning-F57C00?style=flat-square) |
| [Small-Data-Regime-Atlas](https://github.com/rishika1099/Small-Data-Regime-Atlas) | When does gradient boosting stop being the right model? Learning-curve crossovers across 20 tabular datasets, with a meta-feature recommender | JavaScript | ![Machine Learning](https://img.shields.io/badge/Machine_Learning-F57C00?style=flat-square) |
| [Reward-Hacking-Museum](https://github.com/rishika1099/Reward-Hacking-Museum) | A gallery of small environments where a plausible reward produces a degenerate policy, plus an honest look at detection | Python | ![Public Sector](https://img.shields.io/badge/Public_Sector-6D4C41?style=flat-square) ![Machine Learning](https://img.shields.io/badge/Machine_Learning-F57C00?style=flat-square) |
| [Calibration-Budget](https://github.com/rishika1099/Calibration-Budget) | Active learning for hand-eye calibration: D-optimal pose selection reaches target accuracy in far fewer poses | Python | ![Machine Learning](https://img.shields.io/badge/Machine_Learning-F57C00?style=flat-square) |
| [Retrain-Weather-Report](https://github.com/rishika1099/Retrain-Weather-Report) | Forecast when a tabular model will decay from early drift dynamics, with calibrated conformal intervals | Python | ![Machine Learning](https://img.shields.io/badge/Machine_Learning-F57C00?style=flat-square) |
| [Grokking-Forecast](https://github.com/rishika1099/Grokking-Forecast) | Predict the grokking (delayed-generalisation) jump from the first 10% of training, via gradient-noise dynamics | Python | ![Machine Learning](https://img.shields.io/badge/Machine_Learning-F57C00?style=flat-square) |
| [Ambiguity-Detector](https://github.com/rishika1099/Ambiguity-Detector) | A model that knows when a question is underspecified: answer-entropy ambiguity detection with clarifying questions | JavaScript | ![Machine Learning](https://img.shields.io/badge/Machine_Learning-F57C00?style=flat-square) |
| [Label-Noise-Archaeology](https://github.com/rishika1099/Label-Noise-Archaeology) | Recover true labels and annotator reliabilities from noisy votes with Dawid-Skene, and verify only the suspicious labels | Python | ![Machine Learning](https://img.shields.io/badge/Machine_Learning-F57C00?style=flat-square) |
| [OPE-Admits-Defeat](https://github.com/rishika1099/OPE-Admits-Defeat) | A logging simulator with known ground truth that maps where off-policy evaluation estimators lie | Python | ![Public Sector](https://img.shields.io/badge/Public_Sector-6D4C41?style=flat-square) ![Machine Learning](https://img.shields.io/badge/Machine_Learning-F57C00?style=flat-square) |
| [Negative-Controls-Service](https://github.com/rishika1099/Negative-Controls-Service) | Auto-propose and run the negative-control falsification tests an observational analysis should have failed | Python | ![Machine Learning](https://img.shields.io/badge/Machine_Learning-F57C00?style=flat-square) |
| [Synthetic-Control-Small](https://github.com/rishika1099/Synthetic-Control-Small) | Synthetic control on a tiny donor pool with honest placebo-permutation inference for small places | JavaScript | ![Machine Learning](https://img.shields.io/badge/Machine_Learning-F57C00?style=flat-square) |
| [Arguing-Feature-Store](https://github.com/rishika1099/Arguing-Feature-Store) | AutoML that refuses features on cost grounds, not just accuracy: joint accuracy-cost Pareto selection with a per-feature argument | JavaScript | ![Machine Learning](https://img.shields.io/badge/Machine_Learning-F57C00?style=flat-square) |
...
| [Arguing-Grasp](https://github.com/rishika1099/Arguing-Grasp) | Ranked grasp hypotheses with stated reasons and an abstention option, plus the success-vs-coverage curve | Python | ![Machine Learning](https://img.shields.io/badge/Machine_Learning-F57C00?style=flat-square) |
| [Honest-Curriculum](https://github.com/rishika1099/Honest-Curriculum) | Does any data ordering beat shuffling at fixed compute, once scoring cost is counted? An honest negative | Python | ![Machine Learning](https://img.shields.io/badge/Machine_Learning-F57C00?style=flat-square) |
| [Offline-RL-Humility](https://github.com/rishika1099/Offline-RL-Humility) | Offline RL where the headline is the confidence interval's width and the power analysis, not a fragile point estimate | Python | ![Machine Learning](https://img.shields.io/badge/Machine_Learning-F57C00?style=flat-square) |
...
| [Watermark-Survivability](https://github.com/rishika1099/Watermark-Survivability) | What ordinary handling does to an image watermark: survivability cards for a block-DCT scheme (defensive) | Python | ![Computer Vision](https://img.shields.io/badge/Computer_Vision-1E88E5?style=flat-square) |
| [Shortcut-Report](https://github.com/rishika1099/Shortcut-Report) | A leakage audit for image datasets: masked-variant ablations that fingerprint what the dataset really teaches | Python | ![Computer Vision](https://img.shields.io/badge/Computer_Vision-1E88E5?style=flat-square) |
| [Compression-Aware-Vision](https://github.com/rishika1099/Compression-Aware-Vision) | The smallest file that keeps the detector right: per-image JPEG bitrate policy vs a global quality | Python | ![Public Sector](https://img.shields.io/badge/Public_Sector-6D4C41?style=flat-square) ![Computer Vision](https://img.shields.io/badge/Computer_Vision-1E88E5?style=flat-square) |
| [Tactile-From-Sound](https://github.com/rishika1099/Tactile-From-Sound) | A free touch sensor: audio auto-labels contact, a vision model learns it, then the microphone is thrown away | JavaScript | ![Internet of Things](https://img.shields.io/badge/Internet_of_Things-00838F?style=flat-square) ![Computer Vision](https://img.shields.io/badge/Computer_Vision-1E88E5?style=flat-square) |
...
| [Precision-Ladder](https://github.com/rishika1099/Precision-Ladder) | Search which layers actually need their bits: evolutionary per-layer mixed-precision quantization vs uniform | Python | ![High Performance ML](https://img.shields.io/badge/High_Performance_ML-5E35B1?style=flat-square) |
