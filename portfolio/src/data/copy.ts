...
export const copyDefaults: Record<string, CopyBlock> = {
  ...
  "tour.llm.b2": { page: "tour", label: "LLM bullet: art", text: "<strong>AI poem art</strong>: a model distills each poem into one evocative prompt, an image model renders it, cached forever." },
