...
export default function SectionNav({ sections }: { sections: NavSection[] }) {
  ...
  return (
    ...
    >
      <ul className="flex snap-x snap-mandatory gap-2 overflow-x-auto rounded-full bg-cream/80 p-1.5 backdrop-blur-md [scrollbar-width:none] [&::-webkit-scrollbar]{display:none} sm:justify-center sm:overflow-visible">
        {sections.map((s) => {
