  ...
  return (
    <PageShell vibe="dawn" className="flex flex-col items-center text-center">
      <motion.p
        ...
        className="font-hand text-2xl text-ink-soft sm:text-3xl"
      >
      ...
      <motion.h1
        ...
        className="mt-3 font-display text-5xl font-bold leading-tight text-ink text-shadow-soft sm:text-7xl"
      >
        Rishika
        <br />
        Mamidibathula
